...
export default function BeginnerStepGuide({ workflow, userId, context, lastAction, lastStatus, logs }) {
  ...
  async function fetchSteps() {
    ...
    const res = await getWorkflowAdvice({
      workflow,
      userId,
      context: `${context || ""} | Please explain this workflow for a beginner, step by step, in plain English.`,
      lastAction,
      lastStatus,
      logs,
    });
  ...
  return (
    <div className="bg-blue-50 shadow rounded p-4 max-w-md mx-auto mt-6" aria-label="Beginner Step-by-Step Guide">
      <h2 className="font-bold text-lg mb-2">{workflow} Beginner Step-by-Step</h2>
